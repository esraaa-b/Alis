...
{       m->img_map=IMG_Load("mini_map.png");//minimap
	m->img_joueur=IMG_Load("mini_person.png"); // el blanc
	m->pos_map.x=0;
	m->pos_map.y=0;
  	m->pos_joueur.x = 0;
        m->pos_joueur.y =50;
...
{	
	...
	positionChrono.x = 575;
	positionChrono.y = 100;
...
//sdl get p  retrieves the color of a pixel at the specified coordinates on the SDL surface.
